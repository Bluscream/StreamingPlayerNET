...
public class Configuration
{
    ...
    [Description("Theme for the application interface")]
    ...
    [Category("Hotkeys")]
    [DisplayName("Theme Cycle Hotkey")]
    [Description("Keyboard shortcut for cycling through themes")]
    public KeyBind ThemeCycleHotkey { get; set; } = new KeyBind("Ctrl+T");
