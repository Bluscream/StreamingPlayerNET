...
public partial class MainForm
{
    ...
    private void Form1_KeyDown(object? sender, KeyEventArgs e)
    {
        ...
        if (IsHotkeyMatch(e, config.DarkModeHotkey))
        {
            ToggleDarkMode();
            e.Handled = true;
            return;
    ...
    private void SetupMenuEventHandlers()
    {
        ...
        // Dark Mode menu item
        toggleDarkModeMenuItem.Click += (s, e) => ToggleDarkMode();
        ...
        _darkModeMenuItem = toggleDarkModeMenuItem;
    ...
    private void UpdateDarkModeMenuItemText()
    {
